class VocabulariesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @vocabulary.save
        format.html { redirect_to vocabulary_url(@vocabulary), notice: "Vocabulary was successfully created." }
  ...
  def update
    respond_to do |format|
      if @vocabulary.update(vocabulary_params)
        format.html { redirect_to vocabulary_url(@vocabulary), notice: "Vocabulary was successfully updated." }
  ...
  private
    ...
    def vocabulary_params
      params.require(:vocabulary).permit(:japanese, :kanji, :chinese)
    end
end
